  ...
  return (
    <div onClick={onClose} style={{
      ...
      <div onClick={e => e.stopPropagation()} style={{
        background: "white", borderRadius: 16, width: "min(560px, 95vw)",
        ...
        <div style={{ padding: "18px 24px" }}>
          <div style={{ fontSize: 12, marginBottom: 14, padding: "8px 12px", background: "#f8fafc", borderRadius: 8, lineHeight: 1.7 }}>
            <b>To:</b>{" "}
            <span style={{ color: "var(--muted)" }}>{recipients.map(r => r.name).join(", ")}</span>
          </div>
        ...
        <div style={{ padding: "14px 24px", borderTop: "1px solid var(--border)", display: "flex", justifyContent: "flex-end", gap: 8 }}>
          ...
          <button onClick={handleSend} disabled={sending || !subject.trim() || !body.trim()} style={{
            ...
            background: !subject.trim() || !body.trim() ? "#d0d9e6" : "#0e9f6e",
...
const inputStyle: React.CSSProperties = {
  ...
  fontFamily: "var(--sans)", outline: "none", background: "white",
};
